...
class HistoryDataCollaborationSystem:
    ...
    def process_query(self, query: str, timeout: int = 120) -> str:
        """
        Wrapper method for Gradio UI compatibility
        ...
        """
        return self.solve(query, timeout)
...
if __name__ == "__main__":
    ...
    # Define a complex historical question
    question = (
        "How did urbanization rates in Europe compare to those in North America "
        "during the Industrial Revolution, and what were the main factors influencing these trends?"
    )
